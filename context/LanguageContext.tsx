...
const translations: Translations = {
  en: {
    ...
    'section.howItWorks.step3Body': 'If you want the full breakdown and checklist, choose a paid tier and download your professional report.',
    // Who It's For
    ...
    'faq.a2': 'Our rules are based on publicly available Home Office guidance and official immigration rules. We do not have access to your Home Office file and cannot see internal case notes.',
    'faq.q3': 'Can this guarantee my visa will be approved?',
    'faq.a3': 'No. Only the Home Office can make a final decision on any visa application. Our tool gives you an informed view based on public rules so you can understand your risk before you apply.',
    'faq.q4': 'What happens after I pay?',
    'faq.a4': 'You’ll unlock your full report instantly in the browser and be able to download a PDF-style version. You’ll also see your checklist and risk breakdown based on the tier you chose.',
    'faq.q5': 'Do you replace an immigration adviser?',
    'faq.a5': 'No. We do not replace advice from a qualified immigration solicitor or OISC-regulated adviser. Many people use our report to prepare questions before speaking to a professional.',
