...
const translations: Translations = {
  en: {
    ...
    'section.howItWorks.subtitle': 'A structured three-step process to help you understand your immigration standing.',
    'section.howItWorks.step1Title': 'Step 1 – Free pre-check',
    'section.howItWorks.step1Body': 'Answer a short set of questions about your chosen route, financial situation, and history. No payment details required.',
    ...
    'faq.a1': 'No. ClearVisa UK is an automated tool providing informational audits based on public guidance. We are not a law firm and do not provide legal advice.',
    ...
    'partner.benefit4': 'Reliable rule-based logic.',
