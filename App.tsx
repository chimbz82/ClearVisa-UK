...
const App: React.FC = () => {
  ...
  const renderContent = () => {
    switch (viewState) {
      case 'report':
        return (
          <div className="bg-slate-100 min-h-screen py-12 px-4 sm:px-6">
            <div className="max-w-[210mm] mx-auto no-print flex flex-col sm:flex-row justify-between items-center gap-6 mb-12 p-8 bg-white rounded-2xl shadow-xl border border-slate-100">
              <div>
                <h2 className="text-xl font-bold text-navy mb-1">Your Report is Ready</h2>
                <p className="text-sm text-slate-500">Preview and download your confidential assessment below.</p>
              </div>
              <div className="flex items-center gap-4 w-full sm:w-auto">
                ...
                <button 
                  ...
                  className="flex-1 sm:flex-none bg-navy text-white px-8 py-3 rounded-xl font-bold shadow-lg hover:bg-slate-800 transition-all flex items-center justify-center gap-2"
                >
