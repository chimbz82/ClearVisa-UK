...
const Footer: React.FC<FooterProps> = ({ onPrivacyClick, onTermsClick, onScrollToSection }) => {
  ...
  return (
    <footer className="bg-[#07162A] text-white pt-12 pb-8 no-print">
      <div className="app-container">
        <div className="grid grid-cols-1 md:grid-cols-3 gap-10 mb-10">
          <div>
            ...
            <a href="mailto:support@clearvisa.co.uk" className="text-slate-300 hover:text-[#16A34A] text-xs font-semibold underline underline-offset-4 transition-colors">
              support@clearvisa.co.uk
            </a>
          </div>
          
          <div className="md:pl-10">
            <h4 className="font-bold text-[10px] uppercase tracking-[0.2em] text-[#1877F2] mb-6">Navigation</h4>
            <ul className="space-y-3.5 text-slate-300 text-xs font-medium">
          ...
          <div>
            <h4 className="font-bold text-[10px] uppercase tracking-[0.2em] text-[#1877F2] mb-6">Legal</h4>
            <ul className="space-y-3.5 text-slate-300 text-xs font-medium">
