      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-12 mb-16">
          <div className="lg:col-span-2">
            <a href="#" className="text-2xl font-bold flex items-center gap-2 mb-6">
              <span className="w-8 h-8 bg-white text-navy rounded flex items-center justify-center font-serif">UK</span>
          ...
          <div>
            ...
            <ul className="space-y-4 text-slate-400 text-sm">
              ...
              <li><a href="mailto:support@ukvisaprecheck.com" className="hover:text-white transition-colors">Contact Support</a></li>
            </ul>
          </div>
        </div>
        ...
        <div className="pt-10 border-t border-slate-800 flex flex-col md:flex-row justify-between items-center gap-6">
          <p className="text-slate-500 text-xs">
            © 2024 UK Visa Pre-Check. All rights reserved.
          </p>
