...
const Hero: React.FC<HeroProps> = ({ onStartCheck, onScrollToSection }) => {
  ...
  return (
    <section className="relative pt-20 pb-8 lg:pt-32 lg:pb-12 bg-white overflow-hidden">
      <div className="max-w-6xl mx-auto px-6">
        <div className="lg:flex lg:items-center lg:gap-16">
          <div className="lg:w-3/5 text-left">
            ...
            <h1 className="text-3xl sm:text-5xl lg:text-6xl font-extrabold tracking-tight text-navy mb-5 leading-[1.05]">
            ...
            <p className="text-base sm:text-lg text-slate-600 mb-7 max-w-xl leading-relaxed font-medium">
            ...
            <div className="grid grid-cols-1 sm:grid-cols-3 gap-6 pt-5 border-t border-slate-100">
               <div className="flex flex-col">
                  <span className="text-2xl font-black text-navy leading-none mb-0.5">20+</span>
                  <span className="text-[10px] font-bold text-slate-400 uppercase tracking-widest">Countries served</span>
               </div>
               <div className="flex flex-col">
                  <span className="text-2xl font-black text-accent leading-none mb-0.5">94%</span>
                  <span className="text-[10px] font-bold text-slate-400 uppercase tracking-widest">Spouse Visa focus</span>
               </div>
               <div className="flex flex-col">
                  <span className="text-2xl font-black text-success leading-none mb-0.5">&lt;10min</span>
          ...
          <div className="hidden lg:flex lg:w-2/5 justify-end relative">
            <div className="w-full max-w-[400px] bg-navy rounded-2xl p-1 shadow-2xl relative">
