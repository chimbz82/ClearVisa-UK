...
const WhatYouGet: React.FC = () => {
  ...
  return (
    <section className="py-16 md:py-20 bg-navy text-white overflow-hidden relative">
      {/* Decorative Blur */}
      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        <div className="lg:grid lg:grid-cols-2 lg:gap-20 items-center">
          <div>
            <h2 className="text-3xl md:text-4xl font-bold mb-4 lg:mb-5">What you get from your pre-check</h2>
            <p className="text-lg text-slate-400 mb-10 lg:mb-12 font-medium">Not just a score – a structured summary you can actually use.</p>
            ...
            <ul className="space-y-6 lg:space-y-7">
              {deliverables.map((item, idx) => (
                <li key={idx} className="flex items-start gap-4">
                  ...
                  <div>
                    <h4 className="font-bold text-white mb-0.5 lg:mb-1">{item.title}</h4>
            ...
            <div className="mt-10 lg:mt-12 p-3.5 border border-slate-700/50 rounded-lg bg-slate-800/30 inline-block">
