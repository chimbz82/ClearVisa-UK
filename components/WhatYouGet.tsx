              ...
              <div className="bg-slate-50 rounded-[1.5rem] overflow-hidden border border-slate-100">
                <div className="p-5 bg-navy text-white flex items-center justify-between">
                  <div className="flex items-center gap-2.5">
                    <div className="w-6 h-6 bg-white rounded flex items-center justify-center text-[11px] font-black text-navy">C</div>
                ...
                <div className="p-8 space-y-8">
                  <div className="flex items-center gap-5">
                    ...
                    <div>
                      ...
                      <h4 className="text-lg font-black text-navy uppercase tracking-tight">Likely Eligible</h4>
                    </div>
                  </div>
                  ...
                  <div className="flex items-center justify-between bg-success text-white px-5 py-4 rounded-2xl shadow-xl cursor-pointer hover:bg-success/90 transition-all active:scale-[0.98]">
