...
const HowItWorks: React.FC = () => {
  ...
  return (
    <section id="how-it-works" className="py-20 bg-[#F5F7FB] scroll-mt-20">
      <div className="app-container">
        ...
        <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
          {steps.map((step, idx) => (
            <div key={idx} className="app-card flex flex-col min-h-[220px] p-7 hover-card">
              <div className="w-10 h-10 bg-[#F5F7FB] border border-slate-100 text-[#041229] rounded-lg flex items-center justify-center text-sm font-bold mb-6">
                {idx + 1}
              </div>
