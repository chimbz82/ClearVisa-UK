...
const Pricing: React.FC<PricingProps> = ({ onStartCheck }) => {
  return (
    <section id="pricing" className="pt-8 md:pt-12 lg:pt-16 pb-24 bg-slate-50/50">
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        <div className="text-center max-w-3xl mx-auto mb-16">
          <h2 className="text-3xl md:text-4xl font-bold text-navy mb-4">Simple, one-time pricing</h2>
        ...
        <div className="max-w-lg mx-auto">
          <div className="bg-white rounded-3xl shadow-xl border border-slate-100 overflow-hidden transform hover:scale-[1.02] transition-transform">
            <div className="p-10 text-center bg-slate-50 border-b border-slate-100">
              <h3 className="text-sm font-bold text-teal-600 uppercase tracking-widest mb-4">Full Eligibility Pre-Check</h3>
              <div className="flex items-center justify-center gap-1 mb-4">
                <span className="text-4xl font-bold text-navy">£19</span>
                <span className="text-slate-400 font-medium">/ check</span>
              </div>
              <p className="text-slate-600 text-sm">Complete assessment for one route (e.g. spouse or skilled worker)</p>
            </div>
            <div className="p-10">
              ...
              <button 
                ...
                className="w-full bg-navy text-white py-4 rounded-xl text-lg font-bold hover:bg-slate-800 transition-all shadow-lg"
              >
